...
`FP-00 可复现与安全基线` 已验收。V2.1 已完成五领域导航、统一职业事件模型和 MySQL 主库收口。机会守护目前包含市场全景、岗位搜索/详情、简历版本，以及用户主动确认后执行的“JD + 指定简历”AI 辅助分析；分析会落为可追溯证据、结论和待本人确认的行动草稿。我的档案与旧管理中心已合并为统一个人中心；新上传简历保留原件、解析全文、AI 结构化档案和可选活的版本。
