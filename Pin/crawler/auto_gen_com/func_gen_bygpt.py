import os
import sys
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', 'services')); sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..')); from utils import project_path,ner_logger
