...
def replace_img_urls_with_base64(spider_data, _data, soup, _props, _cache_dir):
    return True  # stub: image processing disabled
...
def upload_file_to_obs(*args, **kwargs): return ""  # stub: OBS upload disabled
def save_base64_img(*args, **kwargs): pass  # stub: image processing disabled
