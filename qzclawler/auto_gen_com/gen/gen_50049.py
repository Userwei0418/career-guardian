...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    # ===== 新 API 地址 =====
    api_url = "https://gdhw.zhiye.com/api/Jobad/GetJobAdPageList"
    headers = {
    ...
    # ===== 招聘类型映射 =====
    types = {
        "campus": {"val": 1, "dept": "校园招聘", "base_url": "https://gdhw.zhiye.com/campus/detail?jobAdId={}"},
        "social": {"val": 2, "dept": "社会招聘", "base_url": "https://gdhw.zhiye.com/social/detail?jobAdId={}"},
        "intern": {"val": 3, "dept": "实习招聘", "base_url": "https://gdhw.zhiye.com/intern/detail?jobAdId={}"}
    }
