...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    for item in soup.find_all('div', class_='style__STListItem-editor__sc-10r1nhd-0'):
        ...
        hd_dept = item.find('div', class_='style__STJobLabelText-editor__sc-10r1nhd-13').get_text(strip=True) if item.find('div', class_='style__STJobLabelText-editor__sc-10r1nhd-13') else ""
        hd_loc = ""  # Assuming no location is provided in the HTML
