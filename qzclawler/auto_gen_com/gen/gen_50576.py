...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    for item in soup.find_all('div', class_='style__STListItem-editor__sc-10r1nhd-0'):
        ...
        hd_loc = item.find_all('div', class_='style__STLabelText-editor__sc-10r1nhd-13 cJYhpK')[1].get_text(strip=True) if item.find('div', class_='style__STLabelText-editor__sc-10r1nhd-13 cJYhpK') else ""
