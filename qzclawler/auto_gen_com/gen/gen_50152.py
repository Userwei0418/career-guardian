...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    # ===== 新 API 地址 =====
    api_url = "https://kylinos.zhiye.com/api/Jobad/GetJobAdPageList"
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36",
        "Content-Type": "application/json",
        "Referer": "https://kylinos.zhiye.com/"
    }

    # ===== 招聘类型映射 =====
    types = {
        "campus": {"val": 2, "dept": "校园招聘", "base_url": "https://kylinos.zhiye.com/campus/detail?jobAdId={}"},
        "social": {"val": 1, "dept": "社会招聘", "base_url": "https://kylinos.zhiye.com/social/detail?jobAdId={}"},
        "intern": {"val": 3, "dept": "实习招聘", "base_url": "https://kylinos.zhiye.com/intern/detail?jobAdId={}"}
    }
