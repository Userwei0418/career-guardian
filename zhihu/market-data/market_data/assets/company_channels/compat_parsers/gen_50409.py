...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    for job_card in soup.find_all('div', class_='container-aOp138AX_X'):
        ...
        hd_loc = job_card.find('div', class_='sd-foundation-body-secondary-1Z7H-').text.strip()
        hd_job_num = ""  # Placeholder as the job number is not provided in the HTML
        hd_job_category = ""  # Assuming all jobs are full-time based on the provided HTML
