...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    for item in soup.find_all("div", class_="style__STListItem-editor__sc-10r1nhd-0"):
        ...
        hd_dept = ""
        hd_loc = ""
        hd_job_num = item.find('div', class_='style__STLabelText-editor__sc-10r1nhd-13 cJYhpK', string='若干')

        # 若没有找到“若干”，返回空字符串或其他默认值
        hd_job_num = hd_job_num.text if hd_job_num else ''
        # Placeholder for job number, as the number is not provided in the HTML
