...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    for item in soup.find_all("div", class_="style__STListItem-editor__sc-10r1nhd-0"):
        ...
        hd_dept = ""
        hd_loc = item.find_all("div", class_="style__STJobLabel-editor__sc-10r1nhd-12")[2].get_text(strip=True) if item.find("div", class_="style__STJobLabel-editor__sc-10r1nhd-12") else ""
