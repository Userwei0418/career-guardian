...
def extract_table_from_html(htmlcontext, tempfile):
    ...
    for job_card in soup.find_all('div', class_='container-aOp138AX_X'):
        ...
        hd_dept = job_card.find('div', class_='sd-foundation-body-secondary-1Z7H-').text.strip()
        hd_loc = job_card.find_all('div', class_='sd-foundation-body-secondary-1Z7H-')[-1].text.strip()
