    ...
    def test_empty_database_upgrades_to_head(self):
        ...
        try:
            ...
            try:
                ...
                invocation_columns = {
                    column["name"] for column in inspect(verification_engine).get_columns("ai_invocation_logs")
                }
            ...
            self.assertTrue({"estimated_cost_microunits", "cost_currency"}.issubset(invocation_columns))
