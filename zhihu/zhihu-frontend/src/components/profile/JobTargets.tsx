...
export default function JobTargets({ resumes, onResumeCreated }: { resumes: ResumeVersion[]; onResumeCreated: () => Promise<void> }) {
  ...
  const [interviewTarget, setInterviewTarget] = useState<JobTarget | null>(null);
  ...
  return <div className="space-y-5">
    ...
    {interviewTarget && <MockInterviewDialog target={interviewTarget} onClose={() => setInterviewTarget(null)} />}
  </div>;
}
