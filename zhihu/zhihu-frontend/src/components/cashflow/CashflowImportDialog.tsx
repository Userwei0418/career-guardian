...
function normalizeImportCandidate(candidate: CashflowImportCandidate): CashflowImportCandidate {
  return {
    ...candidate,
    duplicate_matches: Array.isArray(candidate.duplicate_matches) ? candidate.duplicate_matches : [],
  };
}
