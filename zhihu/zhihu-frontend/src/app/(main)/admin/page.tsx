...
function CrawlTaskDetailDialog({ task, detail, loading, error, onClose }: {
  ...
  const actualBrowserMode = snapshotBrowserMode === "headless" || snapshotBrowserMode === "visible" ? snapshotBrowserMode : task.browser_mode;
